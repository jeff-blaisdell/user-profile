...
grails.project.groupId = profile // change this to alter the default package name and Maven publishing destination
...
grails.plugins.springsecurity.userLookup.userDomainClassName = 'profile.User'
grails.plugins.springsecurity.userLookup.usernamePropertyName = 'email'
grails.plugins.springsecurity.userLookup.authorityJoinClassName = 'profile.UserRole'
grails.plugins.springsecurity.authority.className = 'profile.Role'
...
grails.plugins.springsecurity.facebook.domain.classname='profile.FacebookUser'
