                ...
                <g:form id="account-form" name="account" action="register" method="post">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <g:field type="text" class="form-control" name="lastName" required="true" value="${user?.lastName}" />
                        ...
                        <div class="form-group">
                            ...
                            <g:datePicker name="birthDate" noSelection="['':'-Choose-']" required="true" precision="day" value="${user?.birthDate}" />
                        ...
                        <div class="form-group">
                            ...
                            <g:field type="text" name="postalCode" class="form-control" value="${user?.address?.postalCode}" autocomplete="true" />
